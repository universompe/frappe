frappe.ui.Sidebar = class Sidebar {
	...
	make_sidebar() {
		...
		let current_app_data = frappe.boot.app_data_map[frappe.current_app || "frappe"] || frappe.boot.app_data_map["Umpe Universe"] || {};
let app_workspaces = current_app_data.workspaces || [];
